...
bool setSystemProfile(uint8_t perfil) {
  ...
  switch (perfil) {
    case 0: // [Perfil 0] Dron de Observación / Trípode (Movimiento Suave)
      ...
      kalmanRoll.setRmeasure(0.005f); kalmanPitch.setRmeasure(0.005f); // Confiamos mucho en Accel
      kalmanRoll.setQangle(0.001f);   kalmanPitch.setQangle(0.001f);
    ...
    case 1: // [Perfil 1] Vehículo Terrestre (Movimiento Moderado)
      ...
      ACCEL_SCALE = 8192.0; GYRO_SCALE = 65.5;
      kalmanRoll.setRmeasure(0.03f);  kalmanPitch.setRmeasure(0.03f);
      kalmanRoll.setQangle(0.001f);   kalmanPitch.setQangle(0.001f);
    ...
    case 2: // [Perfil 2] Dron Estándar (Dinámico)
      ...
      ACCEL_SCALE = 4096.0; GYRO_SCALE = 32.8;
      kalmanRoll.setRmeasure(0.06f);  kalmanPitch.setRmeasure(0.06f);
      kalmanRoll.setQangle(0.0005f);  kalmanPitch.setQangle(0.0005f);
    ...
    case 3: // [Perfil 3] Misil / Caza (Acrobático y Violento)
      ...
      ACCEL_SCALE = 2048.0; GYRO_SCALE = 16.4;
      kalmanRoll.setRmeasure(0.1f);   kalmanPitch.setRmeasure(0.1f); // Confiamos poco en Accel por ruido G
      kalmanRoll.setQangle(0.0001f);  kalmanPitch.setQangle(0.0001f); // Confiamos mucho en el Gyro
...
void loop() {
    ...
    Wire.read(); Wire.read(); // Omitir Temp
